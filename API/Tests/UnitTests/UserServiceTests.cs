...
namespace AutomationFramwork.API.Tests.UnitTests
{
    ...
    public class UserServiceTests
    {
        ...
        public async Task CreateUserAsync_ShouldReturnCreatedUser_WhenUserIsValid()
        {
            ...
            var createdUser = new User { Id = 1, Name = "Jane Doe" };
            _mockUserApiClient.Setup(x => x.CreateUserAsync(newUser)).ReturnsAsync(createdUser);
        ...
        {
            // Arrange
            var existingUser = new User { Id = 1, Name = "Jane Doe" };
            var updatedUser = new User { Id = 1, Name = "Jane Smith" };
